    ...
    return (
        <ScrollView
            ...
            <ImageBackground
                ...
                <View className='absolute flex-1 flex-col justify-between w-full h-full bg-blue-500/70 pb-4 pt-1'>
                    <Text className='uppercase text-center font-bold text-xl text-white w-11/12 mx-auto rounded-tl-full rounded-br-full py-2'>Amader Doctor</Text>
